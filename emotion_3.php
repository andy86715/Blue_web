...
// 勾選資料寫入
	...
	header("Location: http://localhost/proj-blue/new_page3.php?page=$page2");
	// header("Location: http://d-lab.in/proj-blue/new_page3.php?page=$page2");
?>