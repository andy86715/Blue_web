    ...
    <body>
    	<div id="wrapper">
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
    					<li><a target='_parent' href="index_1.php">首頁</a></li>
    					<li><a target='_parent' href="pagelist_1.php">文章列表</a></li>
                        <li><a target='_parent' href="./track/Llingjing/Llingjing.php">追蹤名單</a></li>
    				</ul>
    				<br class="clearfix" />
    			</div>
    		</div>
    		<div id="page">
    			...
    			<div id="content">
    				<div class="box">
    					<h2><?php
    						while($row_result=mysqli_fetch_assoc($result)){
    							if ($row_result['art_insert1'] == 1) {
                                    echo '['.$row_result['art_classify'].']';
                                    echo $row_result['art_title'];
                                    // echo "---(已評分".",總分:".$row_result2['emotion-grade'].")"."<br>";
                                }else{
                                    echo '['.$row_result['art_classify'].']';
    				...
    				<form action="emotion_1.php" method="post" target="_parent">
                        <strong>總分:</strong>
                        <div>
    					...
    					<div>
    						...
    						<div> 
    							...
    							<strong>備註:</strong>
    							<div class="boxright">
    								<textarea name="notes"><?php echo $row_result2['notes']; ?></textarea>
    							</div>
    						</div>
    					</div>
                        <br>
    			...
    			<div align="center">
    				<ul class="pagination">
    					...
    					if($page > 1) {
    						$prevpage = $page - 1;
    						echo "<li><a target='_parent' href=new_page1.php?page=".$prevpage.">上一篇</a></li> ";
    					} else{
    						echo "<li><a target='_parent' href=new_page1.php?page=1>上一篇</a></li> ";
    					}
    					if ($page < 6) {
    						for( $i=1 ; $i<=6 ; $i++ ) {
    							echo "<li><a target='_parent' href=new_page1.php?page=".$i.">".$i."</a></li> ";
    						} 
    					}elseif ($page >= 6 ) {
    						for( $i=1 ; $i<=$pages ; $i++ ) {
    					...
    					if ($page != $data_nums) {
    						$nextpage = $page + 1;
    						echo "<li><a target='_parent' href=new_page1.php?page=".$nextpage.">下一篇</a></li>";
    					} 
    					?>
    				</ul>
    			</div>
