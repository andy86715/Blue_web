...
$page = $_GET['page'];
$sql = "SELECT * FROM article_all WHERE art_author = 'Llingjing (冷劍塵)' ";
$sql2 = "SELECT * FROM `llingjing_3` WHERE `art_newID` = '$page' ";
    		...
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
                        ...
                        <li><a target='_parent' href="Llingjing_3.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                <option>ID</option>
                                <option value="Llingjing_3.php">LLINGJING (冷劍塵)</option>
