...
// 勾選資料寫入
	...
	header("Location: http://localhost/proj-blue/track/Llingjing/new_page_2.php?page=$page2");
	// header("Location: http://d-lab.in/proj-blue/track/Llingjing/new_page_2.php?page=$page2");
?>