...
$page = $_GET['page'];
// 改
$sql = "SELECT * FROM article_all WHERE art_author = 'yehz (葉子)' ";
//改
$sql2 = "SELECT * FROM `yehz_3` WHERE `art_newID` = '$page' ";
    		...
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="yehz_3.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                ...
                                <option value="yehz_3.php">yehz (葉子)</option>
