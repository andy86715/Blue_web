...
// 改
	header("Location: http://localhost/proj-blue/track/yehz/new_page_2.php?page=$page2");
	// header("Location: http://d-lab.in/proj-blue/track/yehz/new_page_2.php?page=$page2");
?>