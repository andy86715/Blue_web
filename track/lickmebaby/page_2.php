...
//改
$sql2 = "SELECT * FROM `lickmebaby_2` WHERE `art_newID` = '$page' ";
    		...
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="lickmebaby_2.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                ...
                                <option value="lickmebaby_2.php">lickmebaby (孤獨..)</option>
                            </select>
                        </a></li>
    				</ul>
    				<br class="clearfix" />
