...
$page = $_GET['page'];
// 改
$sql = "SELECT * FROM article_all WHERE art_author = 'lickmebaby (孤獨、混亂、失落感..)' ";
//改
$sql2 = "SELECT * FROM `lickmebaby_4` WHERE `art_newID` = '$page' ";
        ...
        <div id="wrapper">
            <div id="header">
                ...
                <div id="menu">
                    <ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="lickmebaby_4.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                <option>ID</option>
                                <!-- 改 -->
                                <option value="../Llingjing/Llingjing_4.php">LLINGJING (冷劍塵)</option>
                                <option value="../zeze/zeze_4.php">zeze (籠中鳥)</option>
                                ...
                                <option value="lickmebaby_4.php">lickmebaby (孤獨..)</option>
                            </select>
                        </a></li>
                    </ul>
                    <br class="clearfix" />
            ...
            <div id="page">
                ...
                <div id="content">
                    ...
                    <form action="emotion_4.php" method="post" target="_parent">
                        <div>
                ...
                <div align="center">
                    <ul class="pagination">
                        ...
                        if($page > 1) {
                            $prevpage = $page + 1;
                            echo "<li><a target='_parent' href=new_page_4.php?page=".$prevpage.">上一篇</a></li> ";
                        } else{
                            echo "<li><a target='_parent' href=new_page_4.php?page=1>上一篇</a></li> ";
                        }
                        if ($page < 6) {
                            for( $i=1 ; $i<=6 ; $i++ ) {
                                echo "<li><a target='_parent' href=new_page_4.php?page=".$i.">".$i."</a></li> ";
                            } 
                        }elseif ($page >= 6 ) {
                            for( $i=1 ; $i<=$pages ; $i++ ) {
                        ...
                        if ($page != $data_nums+1) {
                            $nextpage = $page - 1;
                            echo "<li><a target='_parent' href=new_page_4.php?page=".$nextpage.">下一篇</a></li>";
                        } 
                        ?>
                    </ul>
                </div>
