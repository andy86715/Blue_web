...
$page = $_GET['page'];
// 改
$sql = "SELECT * FROM article_all WHERE art_author = 'viable (viable)' ";
//改
$sql2 = "SELECT * FROM `viable_3` WHERE `art_newID` = '$page' ";
    		...
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="viable_3.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                ...
                                <option value="viable_3.php">viable (viable)</option>
