...
$page = $_GET['page'];
// 改
$sql = "SELECT * FROM article_all WHERE art_author = 'ezk (蒲葵貓)' ";
//改
$sql2 = "SELECT * FROM `ezk_3` WHERE `art_newID` = '$page' ";
    		...
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="ezk_3.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                ...
                                <option value="ezk_3.php">ezk (蒲葵貓)</option>
