...
//改
$sql2 = "SELECT * FROM `gossiplarry_4` WHERE `art_newID` = '$page' ";
            ...
            <div id="header">
                ...
                <div id="menu">
                    <ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="gossiplarry_4.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                ...
                                <option value="gossiplarry_4.php">gossiplarry (賴瑞)</option>
