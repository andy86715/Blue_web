...
// 改
	header("Location: http://localhost/proj-blue/track/gossiplarry/new_page_4.php?page=$page2");
	// header("Location: http://d-lab.in/proj-blue/track/gossiplarry/new_page_4.php?page=$page2");
?>