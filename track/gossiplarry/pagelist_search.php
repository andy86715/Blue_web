<?php
	...
	if (isset($_POST["button"])) {
		$search = $_POST["search"];
		$sql="SELECT * FROM `article_all` where `art_title` like '%".$search."%' or `art_newID` = '$search' or `art_author` like '%".$search."%'";
				...
				<ul>
					...
					<li><a>追蹤名單
                            <select onchange="location = this.value;">
                                ...
                                <option value="gossiplarry.php">gossiplarry (賴瑞)</option>
