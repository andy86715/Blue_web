...
$page = $_GET['page'];
// 改
$sql = "SELECT * FROM article_all WHERE art_author = 'zeze (籠中鳥)' ";
$sql2 = "SELECT * FROM `zeze_3` WHERE `art_newID` = '$page' ";
    		...
    		<div id="header">
    			...
    			<div id="menu">
    				<ul>
                        ...
                        <!-- 改 -->
                        <li><a target='_parent' href="zeze_3.php">追蹤名單</a></li>
                        <li><a>
                            <select onchange="location = this.value;">
                                <option>ID</option>
                                <!-- 改 -->
                                <option value="../Llingjing/Llingjing_3.php">LLINGJING (冷劍塵)</option>
                                <option value="zeze_3.php">zeze (籠中鳥)</option>
