...
$sql2 = "SELECT * FROM `emotion_2` WHERE `art_newID` = '$page' ";
    		...
    		<div id="page">
    			...
    			<div align="center">
    				<ul class="pagination">
    					...
    					if($page > 1) {
    						$prevpage = $page - 1;
    						echo "<li><a target='_parent' href=new_page2.php?page=".$prevpage.">上一篇</a></li> ";
    					} else{
    						echo "<li><a target='_parent' href=new_page2.php?page=1>上一篇</a></li> ";
    					}
    					if ($page < 6) {
    						for( $i=1 ; $i<=6 ; $i++ ) {
    							echo "<li><a target='_parent' href=new_page2.php?page=".$i.">".$i."</a></li> ";
    						} 
    					}elseif ($page >= 6 ) {
    						for( $i=1 ; $i<=$pages ; $i++ ) {
    					...
    					if ($page != $data_nums) {
    						$nextpage = $page + 1;
    						echo "<li><a target='_parent' href=new_page2.php?page=".$nextpage.">下一篇</a></li>";
    					} 
    					?>
    				</ul>
    			</div>
